...
use FOD\DBALClickHouse\Types\BitNumericalClickHouseTypeInterface;
use FOD\DBALClickHouse\Types\DatableClickHouseTypeInterface;
use FOD\DBALClickHouse\Types\NumericalClickHouseTypeInterface;
use FOD\DBALClickHouse\Types\StringClickHouseTypeInterface;
use FOD\DBALClickHouse\Types\UnsignedNumericalClickHouseTypeInterface;
...
class ClickHousePlatform extends AbstractPlatform
{
    ...
    protected const MERGETREE_FAMILY = [
        'MergeTree',
        'CollapsingMergeTree',
        'SummingMergeTree',
    ...
    /**
     * Transform scale parameter to bits with default value.
     *
     * @param int|null $scale
     *
     * @return int
     */
    public function scaleToBits(?int $scale): int
    {
        return BitNumericalClickHouseTypeInterface::SCALE_BIT_MAP[$scale] ?? BitNumericalClickHouseTypeInterface::DEFAULT_BITS;
    }
    ...
    public function getBooleanTypeDeclarationSQL(array $columnDef): string
    {
        return $this->prepareDeclarationSQL(
            UnsignedNumericalClickHouseTypeInterface::UNSIGNED_CHAR .
            NumericalClickHouseTypeInterface::TYPE_INT . BitNumericalClickHouseTypeInterface::EIGHT_BIT,
            $columnDef
        );
    }
    ...
    public function getIntegerTypeDeclarationSQL(array $columnDef): string
    {
        return $this->prepareDeclarationSQL(
            ...
            NumericalClickHouseTypeInterface::TYPE_INT . $this->scaleToBits($columnDef['scale'] ?? null),
            $columnDef
        );
    }
    ...
    public function getBigIntTypeDeclarationSQL(array $columnDef): string
    {
        return $this->prepareDeclarationSQL(
            $this->_getCommonIntegerTypeDeclarationSQL($columnDef) .
            NumericalClickHouseTypeInterface::TYPE_INT . BitNumericalClickHouseTypeInterface::SIXTY_FOUR_BIT,
            $columnDef
        );
    }
    ...
    public function getSmallIntTypeDeclarationSQL(array $columnDef): string
    {
        return $this->prepareDeclarationSQL(
            $this->_getCommonIntegerTypeDeclarationSQL($columnDef) .
            NumericalClickHouseTypeInterface::TYPE_INT . BitNumericalClickHouseTypeInterface::SIXTEEN_BIT,
            $columnDef
        );
    }
    ...
    protected function _getCommonIntegerTypeDeclarationSQL(array $columnDef): string
    {
        if (!empty($columnDef['autoincrement'])) {
            throw new ClickHouseException('Clickhouse do not support AUTO_INCREMENT fields');
        }

        return empty($columnDef['unsigned']) ? '' : UnsignedNumericalClickHouseTypeInterface::UNSIGNED_CHAR;
    }
    ...
    {
        return $fixed
            ? (StringClickHouseTypeInterface::TYPE_FIXED_STRING . '(' . $length . ')')
            : StringClickHouseTypeInterface::TYPE_STRING;
    }
    ...
    {
        return $this->prepareDeclarationSQL(StringClickHouseTypeInterface::TYPE_STRING, $field);
    }
...
//    }
    ...
    protected function _getCreateTableSQL($tableName, array $columns, array $options = []): array
    {
         ...
         */
        if (\in_array($engine, self::MERGETREE_FAMILY, true)) {
            ...
            if (!empty($options['eventDateProviderColumn'])) {
                $options['eventDateProviderColumn'] = \trim($options['eventDateProviderColumn']);
            ...
            if (empty($options['primary'])) {
                throw new ClickHouseException('You need specify PrimaryKey for MergeTree* tables');
            }
    ...
    {
        return $this->prepareDeclarationSQL(StringClickHouseTypeInterface::TYPE_STRING, $columnDef);
    }
    ...
    {
        return $this->prepareDeclarationSQL(DatableClickHouseTypeInterface::TYPE_DATE_TIME, $fieldDeclaration);
    }
    ...
    {
        return $this->prepareDeclarationSQL(StringClickHouseTypeInterface::TYPE_STRING, $fieldDeclaration);
    }
    ...
    {
        return $this->prepareDeclarationSQL(DatableClickHouseTypeInterface::TYPE_DATE, $fieldDeclaration);
    }
    ...
    {
        return $this->prepareDeclarationSQL(
            NumericalClickHouseTypeInterface::TYPE_FLOAT . BitNumericalClickHouseTypeInterface::SIXTY_FOUR_BIT,
            $fieldDeclaration
        );
    }
    ...
    public function getDefaultValueDeclarationSQL($field): string
    {
        ...
        if ($fieldType !== null) {
            if ($fieldType === DatableClickHouseTypeInterface::TYPE_DATE ||
            ...
            } elseif ($fieldType === DatableClickHouseTypeInterface::TYPE_DATE_TIME &&
    ...
    {
        // FixedString
        if (\strncasecmp($dbType, 'fixedstring', 11) === 0) {
            $dbType = 'fixedstring';
        }

        // Enum8
        if (\strncasecmp($dbType, 'enum8', 5) === 0) {
            $dbType = 'enum8';
        }

        // Enum16
        if (\strncasecmp($dbType, 'enum16', 6) === 0) {
            $dbType = 'enum16';
        }
    ...
    /**
     * Prepare SQL Declaration for null.
     *
     * @param string $declarationSQL
    ...
    {
        if (($columnDef['notnull'] ?? true) === false) {
